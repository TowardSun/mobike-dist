...
nohup python run.py --train_cities bj --test_cities nb --model_choice 0 --feature_choice 1 --epochs 200 --gpu 1 > ./logs/bj_nb_cnn_f1.log 2>&1 &
nohup python run.py --train_cities bj --test_cities nb --model_choice 0 --feature_choice 2 --epochs 200 --gpu 1 > ./logs/bj_nb_cnn_f2.log 2>&1 &
nohup python run.py --train_cities bj --test_cities nb --model_choice 0 --feature_choice 3 --epochs 200 --gpu 1 > ./logs/bj_nb_cnn_f3.log 2>&1 &


# multi-source city
# nohup python run.py --train_cities sh,bj --test_cities nb --model_choice 0 --feature_choice 0 --epochs 200 > ./logs/sh_bj_nb_cnn.log 2>&1 &
