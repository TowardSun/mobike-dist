...
nohup python run.py --train_cities bj --test_cities nb --model_choice 0 --feature_choice 1 --epochs 200 > ./logs/bj_nb_scale_cnn_f1.log 2>&1 &
nohup python run.py --train_cities bj --test_cities nb --model_choice 0 --feature_choice 2 --epochs 200 > ./logs/bj_nb_scale_cnn_f2.log 2>&1 &
nohup python run.py --train_cities bj --test_cities nb --model_choice 0 --feature_choice 3 --epochs 200 > ./logs/bj_nb_scale_cnn_f3.log 2>&1 &
